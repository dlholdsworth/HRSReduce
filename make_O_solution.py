...
linelist_path = "./New_HS_H_linelist_P.npy"
arc = "/Users/daniel/Desktop/SALT_HRS_DATA/Blu/2022/1118/reduced/bgoH202211180013.fits"
...
for ord in range(42):
    ...
    waves = peak_wavelengths_ang[ord]['known_wavelengths_vac']
...
for ord in range(42):
    ...
    output[ord]['known_wavelengths_vac'] = wave_out[ii]

#output=np.array([ord_out,lines_out,wave_out])
np.save("./New_HS_H_linelist_O",output)
