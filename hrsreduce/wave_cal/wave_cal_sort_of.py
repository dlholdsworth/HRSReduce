...
class WavelengthCalibration():
    ...
    def __init__(self, arc_file,super_arc,sarm,mode,base_dir,cal_type,plot=False):
        ...
        if self.mode == 'MR' and self.arm == 'H':
            self.linelist_path_U = "./hrsreduce/wave_cal/MR_H_linelist_U.npy"
            self.linelist_path_L = "./hrsreduce/wave_cal/MR_H_linelist_L.npy"
        if self.mode == 'MR' and self.arm == 'R':
            self.linelist_path_U = "./hrsreduce/wave_cal/Intermediate_files/MR_R_linelist_U_NEW.npy"
            self.linelist_path_L = "./hrsreduce/wave_cal/Intermediate_files/MR_R_linelist_L_NEW.npy"
        if self.mode == 'LR' and self.arm == 'H':
            self.linelist_path_U = "./hrsreduce/wave_cal/LR_H_linelist_U.npy"
            self.linelist_path_L = "./hrsreduce/wave_cal/LR_H_linelist_L.npy"
        if self.mode == 'LR' and self.arm == 'R':
            self.linelist_path_U = "./hrsreduce/wave_cal/LR_R_linelist_U.npy"
            self.linelist_path_L = "./hrsreduce/wave_cal/LR_R_linelist_L.npy"
            ...
            with fits.open(self.file) as hdul:
                ...
                if self.cal_type == 'LFC' or 'ThAr':
                    if self.mode == 'HS':
                        ...
                        wl_soln_U, order_precisions_U,absolute_precision_U  = self.alg.run_wavelength_cal_nonHS(U_fluxs,Su_U_fluxes,ref_U_fluxes,self.linelist_path_U,self.nord, self.arm,self.mode,diag_plot,'_U.png')
                        self.logger.info("Overall rms (all orders U): {}".format(absolute_precision_U))
                        
                        wl_soln_L, order_precisions_L, absolute_precision_L = self.alg.run_wavelength_cal_nonHS(L_fluxs,Su_L_fluxes,ref_L_fluxes,self.linelist_path_L,self.nord, self.arm,self.mode,diag_plot,'_L.png')
