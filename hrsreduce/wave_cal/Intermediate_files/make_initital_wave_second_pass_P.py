...
#        wave2 = xconv(np.arange(len(spec2)))
    ...
    #Order 06 range 3885-3945 #Remove first 500 if overlap
    #Order 07 range 3920-3982 #Remove first 500 if overlap
    #Order 08 range 3960-4012
    #Order 09 range 3990-4045
    #Order 10 range 4030-4085
    #Order 11 range 4061-4116
    #Order 12 range 4095-4155
    #Order 13 range 4133-4190 #Use 3rd order poly
    #Order 14 range 4170-4225 #Remove first 350 pixels !!! REVISIT
    #Order 15 range 4205-4265
    #Order 16 range 4245-4307
    #Order 17 range 4285-4347 #Remove first 300 pixels
    #Order 18 range 4325-4390
    #Order 19 range 4365-4430
    #Order 20 range 4405-4470 #Remove first 400 pixels
    ...
    np.save("./HR_H_linelist_P_cl_500s_"+str(ord),output)
