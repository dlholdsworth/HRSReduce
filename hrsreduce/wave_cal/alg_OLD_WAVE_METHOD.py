...
class WaveCalAlg:
    ...
    #    mask = ~lines["flag"]
        ...
        plt.plot(m_wave,(solution - m_wave)/ m_wave * scipy.constants.c,'o')
        plt.show()
    ...
    def run_wavelength_cal_nonHS(self,all_obs,all_super,all_ref,linelist_path, nord, arm,mode,diag_plot,fibre):
        ...
        for ord in range(nord):
            ...
            if arm == 'R':
                ...
                if mode == 'LR':
                    ...
                    degree2 = [4,]
            if mode =='LR':
                HRS_lines = np.loadtxt("./hrsreduce/wave_cal/HRS_LR_linelist.txt", usecols=0, unpack=True)
