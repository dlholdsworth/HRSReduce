...
def compute_mask_line(mask_path, v_steps, zb_min, zb_max, mask_width=1., air_to_vacuum=False):
...
#        line_center=line_center[ii]
#        plt.vlines(line_center,0,line_weight)
#        plt.show()
...
def get_mask_line(mask_path, v_steps, zb_range,  mask_width=1., air_to_vacuum=False):
