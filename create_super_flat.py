...
arms = ['Blu','Red']
modes = ['HR','MR', 'LR']#,'MR','LR','HS']

for mode in modes:
    for arm in arms:

        SuperFlat('2021','/Users/daniel/Desktop/SALT_HRS_DATA/',arm, mode,'20210101','20210630').create_superflat()
        SuperFlat('2021','/Users/daniel/Desktop/SALT_HRS_DATA/',arm, mode,'20210701','20211001').create_superflat()
        
        SuperFlat('2021','/Users/daniel/Desktop/SALT_HRS_DATA/',arm, mode,'20211105','20220112').create_superflat()
        ...
        if mode == 'HS':
            ...
            SuperFlat('2025','/Users/daniel/Desktop/SALT_HRS_DATA/',arm, mode,'20250701','20251231').create_superflat()
